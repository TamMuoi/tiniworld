	...
	<div class="row">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-2.png')}}">
					</a>
				</figure>			
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-4.png')}}">
					</a>
				</figure>			
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-6.png')}}">
					</a>
				</figure>			
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-9.png')}}">
					</a>
				</figure>			
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-11.png')}}">
					</a>
				</figure>			
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9 img-icon-right">
				<figure class="wpb_wrapper vc_figure">
					<a href="https://tiniworld.com/vi/khu-vui-choi/juno-playland/" target="_self" class="vc_single_image-wrapper   vc_box_border_grey">
						<img src="{{asset('images/khuvuichoi/gocvuichoi-12.png')}}">
					</a>
				</figure>			
